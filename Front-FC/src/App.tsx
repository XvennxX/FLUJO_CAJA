...
import DashboardPagaduria from './pages/DashboardPagaduria';
import DashboardTesoreria from './pages/DashboardTesoreria';
...
import HistoricoTRM from './pages/HistoricoTRM';
